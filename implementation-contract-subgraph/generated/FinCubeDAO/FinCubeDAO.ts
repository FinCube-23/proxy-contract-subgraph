...
export class FinCubeDAO__getOngoingProposalsResultValue0Struct extends ethereum.Tuple {
...
export class FinCubeDAO__getProposalsByPageResultPaginateProposalsStruct extends ethereum.Tuple {
  get executed(): boolean {
    return this[0].toBoolean();
  }
...
export class FinCubeDAO__getProposalsByPageResult {
  value0: Array<FinCubeDAO__getProposalsByPageResultPaginateProposalsStruct>;
  value1: BigInt;
  ...
  getPaginateProposals(): Array<FinCubeDAO__getProposalsByPageResultPaginateProposalsStruct> {
    return this.value0;
  }
...
export class FinCubeDAO extends ethereum.SmartContract {
  static bind(address: Address): FinCubeDAO {
    return new FinCubeDAO("FinCubeDAO", address);
  }
  ...
  getOngoingProposals(): Array<FinCubeDAO__getOngoingProposalsResultValue0Struct> {
    let result = super.call(
      "getOngoingProposals",
      "getOngoingProposals():((bool,bool,address,bytes,address,uint48,uint48,uint256,uint256,string)[])",
      [],
    );

    return result[0].toTupleArray<FinCubeDAO__getOngoingProposalsResultValue0Struct>();
  }

  try_getOngoingProposals(): ethereum.CallResult<
    Array<FinCubeDAO__getOngoingProposalsResultValue0Struct>
  > {
    let result = super.tryCall(
      "getOngoingProposals",
      "getOngoingProposals():((bool,bool,address,bytes,address,uint48,uint48,uint256,uint256,string)[])",
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<FinCubeDAO__getOngoingProposalsResultValue0Struct>(),
    );
  }
  ...
  getProposalsByPage(
    cursor: BigInt,
    howMany: BigInt,
  ): FinCubeDAO__getProposalsByPageResult {
    let result = super.call(
      "getProposalsByPage",
      "getProposalsByPage(uint256,uint256):((bool,bool,address,bytes,address,uint48,uint48,uint256,uint256,string)[],uint256)",
      [
    ...
    return new FinCubeDAO__getProposalsByPageResult(
      result[0].toTupleArray<FinCubeDAO__getProposalsByPageResultPaginateProposalsStruct>(),
      result[1].toBigInt(),
    );
  }

  try_getProposalsByPage(
    cursor: BigInt,
    howMany: BigInt,
  ): ethereum.CallResult<FinCubeDAO__getProposalsByPageResult> {
    let result = super.tryCall(
      "getProposalsByPage",
      "getProposalsByPage(uint256,uint256):((bool,bool,address,bytes,address,uint48,uint48,uint256,uint256,string)[],uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FinCubeDAO__getProposalsByPageResult(
        value[0].toTupleArray<FinCubeDAO__getProposalsByPageResultPaginateProposalsStruct>(),
        value[1].toBigInt(),
      ),
    );
  }
  ...
  try_getVotingPeriod(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getVotingPeriod",
      "getVotingPeriod():(uint256)",
      [],
